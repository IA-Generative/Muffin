...
class Task(UUIDMixin, TimestampMixin, Base):
    ...
    # Both nullable and independent: not every task type relates to a
    # document (e.g. a future collection-wide summary task), and a document
    # can outlive the task that created it either way.
